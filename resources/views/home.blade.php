...
<body class="bg-gray-900 text-gray-200 font-sans">
                ...
                <aside class="bg-gray-800 p-4 sm:p-6 shadow-md rounded-lg">
                    ...
                    <div class="flex flex-row w-full space-x-4 justify-evenly text-sm text-gray-400">
                        ...
                        <a href="mailto:colidom@outlook.com"
                           class="flex items-center text-gray-200 transition-transform duration-300 transform hover:scale-105 hover:bg-gray-700 p-1 rounded-md">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1" fill="currentColor" viewBox="0 0 24 24">
                                <path d="M12 12.713l8.193-5.193c.195-.124.325-.344.325-.607V4.07c0-.552-.447-1-1-1H4.513c-.553 0-1 .448-1 1v2.843c0 .263.13.483.325.607L12 12.713zM12 14.062L4 9.045V20h16V9.045l-8 5.017z" />
                            </svg>
                            Email
                        </a>
                    </div>
    ...
    <footer class="bg-gray-800 p-4 mt-auto">
        <div class="text-center text-gray-400">
            {{ date('Y') }} Hecho con ❤ por <span class="font-bold text-blue-500">colidom</span>.
        </div>
    </footer>
